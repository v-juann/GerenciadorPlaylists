...
public class ArtistasFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nome do Artista", "Gênero Musical", "generoId"
            }
        ) {
    ...
    private void adicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Erro ao carregar gêneros: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (JOptionPane.showConfirmDialog(this, panel, "Adicionar Artista",
            ...
            try {
                if (nomeField.getText().trim().isEmpty() || generoCombo.getSelectedItem() == null) {
                ...
                ArtistasModel.create(new ArtistasBean(0, nomeField.getText().trim(),
                        selectedGenero.getNome(), selectedGenero.getIdGenero()), getConnection());
                loadData();
            } catch (SQLException ex) {
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        ...
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        int id = (int) dtm.getValueAt(row, 0);
        int currentGenreId = (int) dtm.getValueAt(row, 3);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ArtistasFrame.class.getName()).log(
